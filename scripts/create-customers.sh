...
docker exec \
    ...
    -c '{"function":"AddCustomers","Args":["[{\"id\":\"C010\",\"firstName\":\"Ana\",\"lastName\":\"Petrovic\",\"email\":\"ana.petrovic@example.com\",\"invoices\":[],\"accountBalance\":60000},{\"id\":\"C011\",\"firstName\":\"Marko\",\"lastName\":\"Ilic\",\"email\":\"marko.ilic@example.com\",\"invoices\":[],\"accountBalance\":45000}]"]}'
