...
docker exec \
    ...
    -c '{"function":"AddProductsToMerchant","Args":["M002","[{\"ID\":\"P008\",\"Name\":\"Motor Oil\",\"ExpirationDate\":\"\",\"Price\":1500,\"Quantity\":20},{\"ID\":\"P009\",\"Name\":\"Air Filter\",\"ExpirationDate\":\"\",\"Price\":800,\"Quantity\":15}]"]}'
